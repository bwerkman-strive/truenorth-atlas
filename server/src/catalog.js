...
export const METRICS = [
  ...
  // ------------------------------------------------------------ behavior / lifespan
  {
    ...
    explain: 'A transfer of 100 BTC that sat for 1,000 days destroys 100,000 coin-days. CDD therefore amplifies the movement of old, high-conviction coins and mutes exchange churn. Sustained CDD spikes mean long-dormant holders are repositioning — information ordinary volume cannot show.',
