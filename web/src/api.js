...
export const api = {
  ...
  admin: {
    ...
    metricCopy: (token) => authed('GET', '/api/admin/metric-copy', token),
    saveMetricCopy: (token, slug, body) => authed('PUT', `/api/admin/metric-copy/${slug}`, token, body),
    resetMetricCopy: (token, slug) => authed('DELETE', `/api/admin/metric-copy/${slug}`, token),
...
export { fmt, compact, fmtDay, axisTick } from './format.js';
