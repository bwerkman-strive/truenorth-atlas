...
export const API_ENDPOINTS = [
  ...
  },
  {
    ...
    response: {
      ...
      outputs: [
        { n: 0, value_btc: 0.15, address: '1BvBMSEYstWetqTFn5Au4m4GFg7xJaNVN2', type: 'pubkeyhash', scriptpubkey_asm: 'OP_DUP OP_HASH160 76a915…88ac OP_EQUALVERIFY OP_CHECKSIG', spent: false },
        { n: 1, value_btc: 0.0705, address: 'bc1qar0srrr7xfkvy5l643lydnw9re59gtzzwf5mdq', type: 'v0_p2wpkh', scriptpubkey_asm: 'OP_0 OP_PUSHBYTES_20 e8df01…8f45', spent: true },
      ],
      rpc: true,
    },
    notes: 'Coinbase transactions return "coinbase": true, null fee fields, and inputs: [{ "coinbase": true }]. "confirmations" is 0 for mempool transactions. Without RPC, outputs still tracked in the UTXO set are returned with "rpc": false and null node-only fields.',
  },
  {
    method: 'GET',
